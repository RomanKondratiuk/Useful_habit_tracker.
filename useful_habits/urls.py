...
from useful_habits.views import HabitCreateApiView, HabitListApiView, \
    ...
    HabitDestroyAPIView, FeelingListApiView, \
    FeelingRetrieveApiView, FeelingCreateApiView, FeelingUpdateApiView, \
...
urlpatterns = [
    ...
    path('feeling/<int:pk>/', FeelingRetrieveApiView.as_view(),
         name='read one feeling'),
    path('feeling/create/', FeelingCreateApiView.as_view(),
         name='feeling-create'),
    path('feeling/update/<int:pk>/', FeelingUpdateApiView.as_view(),
         name='feeling-update'),
    path('feeling/delete/<int:pk>/', FeelingDestroyAPIView.as_view(),
         name='feeling-delete'),
]
